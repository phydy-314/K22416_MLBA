...
# area
x = np.array([[73.5, 75., 76., 76.5, 79., 81.5, 82.5, 84., 85., 86.5, 87.5, 89., 90., 91.5]]).T
# price
y = np.array([[1.49, 1.50, 1.51, 1.51, 1.54, 1.58, 1.59, 1.60, 1.62, 1.63, 1.64, 1.66, 1.67, 1.68]]).T
# input matrix X
